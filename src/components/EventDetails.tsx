...
export default function EventDetails() {
  ...
  return (
    <section ref={ref} id="details" style={{ padding: sectionPad, ...reveal(visible) }}>
      <div style={{ maxWidth: "66rem", margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "1.6rem", marginTop: "clamp(2rem,4vw,3rem)", textAlign: "center" }}>
          {icons.map((i) => (
