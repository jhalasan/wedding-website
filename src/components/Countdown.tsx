...
export default function Countdown() {
  ...
  return (
    <section ref={ref} style={{ background: c.sand, borderTop: `1px solid ${c.line}`, borderBottom: `1px solid ${c.line}`, padding: "clamp(2.4rem,5vw,3.4rem) clamp(1.25rem,5vw,3rem)", ...reveal(visible) }}>
      <div style={{ maxWidth: "60rem", margin: "0 auto", display: "flex", flexDirection: "column", alignItems: "center", gap: "1.6rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 1, background: c.line, width: "100%", maxWidth: "44rem" }}>
          {units.map((u) => (
